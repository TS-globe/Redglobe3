...
console.log(msg);
  ...
  document.getElementById("output").innerHTML+="<div><h1 id='sender'>"+ sender +"<img src='tick.png' id='tick'></h1><br><p class='message_h4'>"+ msg +"</p><br><button onclick='like1(this.id)' value="+ like +" class='like_button ' id="+firebase_message_id+">Like: "+ like +"</button></div> <i class='fa-thin fa-thumbs-up'>"
//End code
      } });  }); }
getData();
